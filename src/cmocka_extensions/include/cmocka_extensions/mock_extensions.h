...
/*  If using MOCK_FUNC_ALWAYS in a test case make sure to call MOCK_FUNC_DISABLE
   on cleanup or other test cases would be effected by MOCK_FUNC_ALWAYS.
*/
#define MOCK_FUNC_AFTER_CALL(__mockf, __mocka)                                 \
...
#define MOCK_FUNC_VAR_NEW(__name)                                              \
  cmockaMock_t __mock##_##__name = CMOCKA_MOCK_INIT
